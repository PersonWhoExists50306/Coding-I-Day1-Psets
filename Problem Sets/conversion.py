...
# Problem 0 
print("Problem 0")
hours = int(input("How many full hours? "))
minutes = int(input("How many extra minutes? "))
totalMins = (60 * hours) + minutes
print(f"{totalMins} minutes")

# Problem 1 
print("Problem 1")
justHours = hours + (minutes / 60)
print(f"{justHours} hours")
